...
public class BasePresenter implements ListItemClickListener {
    ...
    public static BasePresenter getInstance() {
        if (null == basePresenter) return new BasePresenter();
        return basePresenter;
    }

    public void setOnClickListenerForErrorMsg (ImageView errorIV, final TextView errorTV){
     ...
     */
    public void onClickMsgIV(TextView errorTV){
